...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://foqz.github.io/";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        ...
        String taskName = "Tasnk number " + generator.nextInt(100000);
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("user@gmail.com");  //-< fake trello username and pass
        driverTrello.findElement(By.id("password")).sendKeys("userpass");
...
//                .forEach(aHref -> aHref.click());
        WebElement kodillaBoard = driverTrello.findElement(By.xpath("//div[contains(@title, \"Kodilla\")]"));
        kodillaBoard.click();
        Thread.sleep(2000);
