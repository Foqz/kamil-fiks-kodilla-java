...
public class BookDirectoryTestSuite {
    ...
    public void  testListBooksInHandsOfWhen0(){
        ...
        LibraryUser user1 = new LibraryUser("John","Whick","11114444");
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(resultListOf5Books);
        //When
        List<Book> theList = bookLibrary.listBooksInHandsOf(user1);

        //Then
        assertEquals(0,theList.size());
    }
    @Test
    public void  testListBooksInHandsOfWhen1(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Test
    public void  testListBooksInHandsOfWhen5(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
